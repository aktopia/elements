...
const AddMedia = () => {
  return (
    <div
      className={
        'duration-250 group flex h-56 w-full cursor-pointer flex-col items-center justify-center rounded-lg border border-2 border-dashed border-gray-300 transition ease-in-out sm:h-52 sm:hover:border-gray-400'
      }>
...
export const MediaGallery = ({ images }: any) => {
  return (
    <div className={'space-y-6'}>
      <p className={'w-full text-center text-gray-400'}>{'Drag and drop your media here'}</p>
